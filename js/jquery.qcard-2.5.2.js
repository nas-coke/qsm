...
(function ($) {
		var settings = {
						...
						//footertext:"QcardVer2.5.2 by <a href='http://hosting.m108.com'>m108.com</a>",
						soundspeed:10,// max 200
						soundvolume:100,//max 100
						//cookiename:'qcard.m108.com',
						isrefresh:1
		};
		...
		//soundManager.soundfolder = 'sound/mr/';
		soundManager.soundfolder = 'sound/th/';
	...
	$.extend({
		...
		ckget:function(){
			return $.JSONCookie(settings.cookiename);
		},
		
		ckpost:function(o){
			$.JSONCookie(settings.cookiename, o, {path: '/'});
		},
		...
		playAudio2:function(playlistId,callback){
			...
			sound.play({ position: settings.soundspeed,volume:settings.soundvolume,onfinish:function(){
                playlistId ++;
