...
playQueueSound:function(queue,channel){
	...
	disprefresh:function(isstart){
		...
		$(".disp").append("<div class=\"disp_title\" ><div class=\"disp_queue\" >"+o.title_queue+"</div><div class=\"disp_counter_no\"><div>"+o.title_counter+"</div></div></div>");
		$(".disp").append("<div class=\"disp_counter\" ><div class=\"disp_queue\" ></div><div class=\"disp_counter_no\"></div><div class=\"disp_help\"></div></div>");
		$(".disp").append("<div class=\"disp_footer\" ><div>"+o.footertext+"</div></div>");
		$(".disp").append("<div  id=\"disp_dialog\" ><div class=\"menu\"></div><div class=\"content\"></div>");
